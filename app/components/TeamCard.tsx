...
const TeamCard = ({ img, game }: { img: StaticImageData, game: string }) => {
    return (
        <Link href={`/teams/${game}`} className='relative group min-w-64 h-[60vh] cyan_shadow rounded-3xl hover:shadow-none hover:translate-x-2 hover:translate-y-2 duration-100'>
